...
public class PrioritizedObject<T> implements Comparable<PrioritizedObject>
{
     ...
     */
    public PrioritizedObject(T element, int time, int priority) //added time varible
    {
    ...
    /*
      Returns all three varibles in the element in string form
    */
    public String getAll(){
      String all = (element + " " + time + " " + priority);
      return all;
    }
     ...
     *
     */
    public String toString() //added time varible
    {
        return (element + "  " + time + "  " + priority + "  " + arrivalOrder);
    }
